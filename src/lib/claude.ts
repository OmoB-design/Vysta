...
export function buildCalculatorInsightPrompt(
  ...
  return `You are a senior Google Ads consultant at Adcubator, a specialist Google & YouTube Ads agency for e-commerce brands.
...
- What they could be making at Adcubator's 8.78x average: $${Math.round(results.projectedRevenue).toLocaleString()}
